...
namespace BeaVeR
{
  public class BlockSpawner : MonoBehaviour
  {
    ...
    private void Awake()
    {
      stageController.StartLevelRequested += StageController_OnStartLevelRequested;
      stageController.StopLevelRequested += StageController_OnStopLevelRequested;
    }
    ...
    private void StageController_OnStopLevelRequested(object sender, EventArgs e)
    {
      foreach (Block block in blocksParent.GetComponentsInChildren<Block>())
      {
        block.DestroyYourself();
      }
    }

    private void StageController_OnStartLevelRequested(object sender, EventArgs e)
    {
