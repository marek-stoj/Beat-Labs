...
namespace UnityEngine.XR.Interaction.Toolkit.Inputs.Simulation
{
    ...
    public class XRDeviceSimulatorEx : MonoBehaviour
    {
        public Vector3 HmdCenterEyePosition
        {
            get => m_HMDState.centerEyePosition;
            set => m_HMDState.centerEyePosition = value;
        }

        public Vector3 LeftControllerDevicePosition
        {
            get => m_LeftControllerState.devicePosition;
            set => m_LeftControllerState.devicePosition = value;
        }

        public Vector3 RightControllerDevicePosition
        {
            get => m_RightControllerState.devicePosition;
            set => m_RightControllerState.devicePosition = value;
        }
